...
def gensources(complist='src.cl'):
    ...
    cl.addcomponent(dir=srcdirection, flux=1.0, fluxunit='Jy', freq='1.4GHz', shape="Gaussian", 
                    majoraxis="1arcsec", minoraxis='1arcsec', positionangle='0deg')
    cl.rename(complist)
    cl.done()


def simulate(complist='src.cl', outms='dsa110-calsrc.ms'):
    """ Use source model to generate simulated ms
    """
